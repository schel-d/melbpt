...
/**
 * Returns the icon in SVG format.
 * @param icon The name of the icon.
 */
export function iconSVG(icon: string): SVGSVGElement {
  ...
  svg.innerHTML = getIconData(icon);
 ...
 * @param icon The name of the icon.
 */
export function getIconData(icon: string): string {
  const chosen = iconLibrary[icon];
  if (chosen == null) { throw new Error(`Icon not found: "${icon}"`); }
  return chosen;
}

/** The library of all supported icons. */
const iconLibrary: { [index: string]: string } = {
